  ...
  return (
    <div className=" relative -translate-x-1/2 items-center flex-col">
      <div className=" flex items-center flex-col w-fit">
        ...
        <span className="text-neutral-400 ">You don't have an account? <button tabIndex={-!loginScreen} className="text-neutral-200 hover:text-neutral-50 underline-offset-2 underline cursor-pointer" onClick={() => setLoginScreen(false)}>Create One</button> </span>
        <OrSeparator />
